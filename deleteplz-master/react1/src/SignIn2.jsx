                        ...
                        <div className="login">
                            ...
                            <form className="form1" onSubmit={handleSignupSubmit}>
                                <div className="inputinfo">
                                    <label>아이디</label>
                                    <input type="text" className={`input-text ${!isidValid ? "invalid" : ""}`} value={id} onChange={(e) => setId(e.target.value)} />
                                    <span>{idCheckMessage}</span>
                                </div>
                                <div className="inputinfo">
                                    <label>비밀번호</label>
                                    <input type="passwd" className="input-passwd" value={passwd} onChange={(e) => setPasswd(e.target.value)} />
                                </div>
                                <div className="inputinfo">
                                    <label>비밀번호 확인</label>
