...
const RouterComponent = () => {
  return (
    <Routes>
      ...
      <Route path="/designer/DesignerContractCreate" element={<DesignerContractCreatePage />} />
      <Route path="/designer/DesignerContractManage" element={<DesignerContractManagePage />} />
